...
int WINAPI wWinMain( HINSTANCE hInst,HINSTANCE,LPWSTR,INT )
{
	WNDCLASSEX wc = { sizeof( WNDCLASSEX ),CS_CLASSDC,MsgProc,0,0,
                      ...
                      L"Game DirectX Framework Window",NULL };
//    wc.hIconSm = (HICON)LoadImage( hInst,MAKEINTRESOURCE( IDI_APPICON16 ),IMAGE_ICON,16,16,0 );
    ...
    HWND hWnd = CreateWindowW( L"Game DirectX Framework Window",L"Shape Smack",
    ...
    UnregisterClass( L"Game DirectX Framework Window",wc.hInstance );
    return 0;
}